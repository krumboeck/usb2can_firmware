...
/* M24C16WP 8 blocks (256bytes each) */
#define EEPROM_Block0_ADDRESS 0xA0
#define EEPROM_Block1_ADDRESS 0xA2
#define EEPROM_Block2_ADDRESS 0xA4
#define EEPROM_Block3_ADDRESS 0xA6
#define EEPROM_Block4_ADDRESS 0xA8
#define EEPROM_Block5_ADDRESS 0xAA
#define EEPROM_Block6_ADDRESS 0xAC
#define EEPROM_Block7_ADDRESS 0xAE
